...
@Suite.SuiteClasses({ LogServiceSessionAuthorizationFilterTestUnit.class })
...
@CreateLdapServer(transports = { @CreateTransport(address = "localhost", protocol = "LDAP", port=21389) })
public class SolrExtentionsLDAPSuiteTest {
